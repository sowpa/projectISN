...
if exist "League of Legends.exe" (
	@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator spectator.euw1.lol.riotgames.com:80 2WHUBFxcQlNIoywSreGSvcTsJ9pZnHRE 3089384021 EUW1" "-UseRads"
	goto :eof
)
:cannotFind
echo ===================
